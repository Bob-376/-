        ...
        <div className="flex items-center gap-4 bg-black/20 px-4 py-1.5 rounded-xl border border-white/5 shadow-inner flex-1 max-w-md">
          <div className="flex flex-col items-start min-w-[90px]">
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-[7px] font-bold text-white/40 uppercase">/ {epicGoal/1000}K WORDS</span>
            </div>
          ...
          <div className="flex flex-col items-start">
            ...
            <span className="text-[6px] font-black uppercase tracking-widest text-white/20">TOTAL TSHEGS</span>
          </div>
        </div>
